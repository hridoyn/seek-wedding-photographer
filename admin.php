...
$jsonData= getJSONFromDB("select * from admin where Username='$username' and Password='$password'");
if($jsn=json_decode($jsonData,true)){
for($i=0;$i<sizeof($jsn);$i++){
		echo  "<span class='name'>" ."Welcome:"." ".$jsn[$i]['Username']."<br>"."</span>";
		
	echo '<form action="firstpage4.html">
...
echo '<p><a href="AdminLogin.html">Go Back</a></p>';
}
